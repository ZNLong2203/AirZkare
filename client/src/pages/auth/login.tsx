      ...
      <div className="hidden md:flex relative bg-[#4169E1] text-white">
        ...
        <div className="relative flex flex-col items-center justify-center p-12 text-center">
          ...
          <p className="text-lg text-white/90 mb-12 max-w-md">
            Discover amazing destinations and book your next adventure with AirZkare
          </p>
          ...
          <div className="grid gap-8 text-left w-full max-w-md">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/75">Find the most competitive prices for your travel needs</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/75">Your transactions are protected with advanced encryption</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/75">Our dedicated team is always ready to assist you</p>
              </div>
            </div>
          </div>
        </div>
